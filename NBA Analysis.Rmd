...
```{r }
# Residual Analysis
vars = all.vars(formula(model_backward))[-1]

resids = stdres(model_backward)
par(mfrow=(c(2,3)))
...
resids = stdres(model_backward)
par(mfrow=(c(2,3)))
plot(train$s_3PA, resids, xlab='s_3PA', ylab='Residuals')
abline(0,0, col='red')
plot(train$s_FTA, resids, xlab='s_FTA', ylab='Residuals')
abline(0,0, col='red')
plot(train$s_OREB, resids, xlab='s_OREB', ylab='Residuals')
abline(0,0, col='red')
```
